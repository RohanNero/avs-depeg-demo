...
library DepegDeploymentLib {
    ...
    function deployContracts(
        ...
        result.depegServiceManager = UpgradeableProxyLib.setUpEmptyProxy(
            proxyAdmin
        );
        ...
        address depegServiceManagerImpl = address(
            new DepegServiceManager(
                core.avsDirectory,
        ...
        bytes memory upgradeCall = abi.encodeCall(
            ...
            (result.depegServiceManager, 0, quorum)
        );
        ...
        UpgradeableProxyLib.upgrade(
            result.depegServiceManager,
            depegServiceManagerImpl
        );
    ...
    function readDeploymentJson(
        ...
        data.depegServiceManager = json.readAddress(
            ".contracts.depegServiceManager"
        );
    ...
    function writeDeploymentJson(DeploymentData memory data) internal {
        writeDeploymentJson("deployments/depeg/", block.chainid, data);
    }
    ...
    function writeDeploymentJson(
        ...
        address proxyAdmin = address(
            UpgradeableProxyLib.getProxyAdmin(data.depegServiceManager)
        );
    ...
    function _generateContractsJson(
        ...
        return
            string.concat(
                ...
                '","depegServiceManager":"',
                data.depegServiceManager.toHexString(),
                '","depegServiceManagerImpl":"',
                data.depegServiceManager.getImplementation().toHexString(),
                '","stakeRegistry":"',
