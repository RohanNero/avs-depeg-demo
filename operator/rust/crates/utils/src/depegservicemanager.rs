...
pub mod IDepegServiceManager {
    ...
    /**Creates a new wrapper around an on-chain [`IDepegServiceManager`](self) contract instance.

    See the [wrapper's documentation](`IDepegServiceManagerInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IDepegServiceManagerInstance<T, P, N> {
        IDepegServiceManagerInstance::<T, P, N>::new(address, provider)
    }
    /**A [`IDepegServiceManager`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`IDepegServiceManager`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    #[derive(Clone)]
    pub struct IDepegServiceManagerInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IDepegServiceManagerInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IDepegServiceManagerInstance")
                .field(&self.address)
                .finish()
        }
    }
    ...
    impl<T, P: ::core::clone::Clone, N> IDepegServiceManagerInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IDepegServiceManagerInstance<T, P, N> {
            IDepegServiceManagerInstance {
...
interface DepegServiceManager {
    event Initialized(uint8 version);
    event NewTaskCreated(uint32 indexed taskIndex, IDepegServiceManager.Task task);
    event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    event RewardsInitiatorUpdated(address prevRewardsInitiator, address newRewardsInitiator);
    event TaskResponded(uint32 indexed taskIndex, IDepegServiceManager.Task task, address operator);
    ...
    function createNewTask(string memory name) external returns (IDepegServiceManager.Task memory);
    ...
    function respondToTask(IDepegServiceManager.Task memory task, uint32 referenceTaskIndex, bytes memory signature) external;
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IDepegServiceManager.Task",
        "components": [
          {
            "name": "name",
            "type": "string",
...
pub mod DepegServiceManager {
    ...
    pub struct NewTaskCreated {
        ...
        pub taskIndex: u32,
        #[allow(missing_docs)]
        pub task: <IDepegServiceManager::Task as alloy::sol_types::SolType>::RustType,
    }
    #[allow(non_camel_case_types, non_snake_case, clippy::style)]
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        ...
        impl alloy_sol_types::SolEvent for NewTaskCreated {
            type DataTuple<'a> = (IDepegServiceManager::Task,);
            type DataToken<'a> = <Self::DataTuple<'a> as alloy_sol_types::SolType>::Token<'a>;
            type TopicList = (
            ...
            fn tokenize_body(&self) -> Self::DataToken<'_> {
                (
                    <IDepegServiceManager::Task as alloy_sol_types::SolType>::tokenize(
                        &self.task,
                    ),
                )
            }
    ...
    pub struct createNewTaskReturn {
        pub _0: <IDepegServiceManager::Task as alloy::sol_types::SolType>::RustType,
    }
    #[allow(non_camel_case_types, non_snake_case, clippy::style)]
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        ...
        {
            #[doc(hidden)]
            type UnderlyingSolTuple<'a> = (IDepegServiceManager::Task,);
            #[doc(hidden)]
            type UnderlyingRustTuple<'a> =
                (<IDepegServiceManager::Task as alloy::sol_types::SolType>::RustType,);
            #[cfg(test)]
            #[allow(dead_code, unreachable_patterns)]
            fn _type_assertion(_t: alloy_sol_types::private::AssertTypeEq<UnderlyingRustTuple>) {
                match _t {
        ...
        impl alloy_sol_types::SolCall for createNewTaskCall {
            ...
            type ReturnTuple<'a> = (IDepegServiceManager::Task,);
            type ReturnToken<'a> = <Self::ReturnTuple<'a> as alloy_sol_types::SolType>::Token<'a>;
    ...
    ///Container for all the [`DepegServiceManager`](self) function calls.
    pub enum DepegServiceManagerCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for DepegServiceManagerCalls {
        const NAME: &'static str = "DepegServiceManagerCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<DepegServiceManagerCalls>] = &[
                {
                    fn allTaskHashes(
                        data: &[u8],
                        validate: bool,
                    ) -> alloy_sol_types::Result<DepegServiceManagerCalls>
                    {
                        ...
                        .map(DepegServiceManagerCalls::allTaskHashes)
                    }
                    allTaskHashes
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<DepegServiceManagerCalls>
                    {
                        <getOperatorRestakedStrategiesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                DepegServiceManagerCalls::getOperatorRestakedStrategies,
                            )
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<DepegServiceManagerCalls>
                    {
                        ...
                        .map(DepegServiceManagerCalls::respondToTask)
                    }
                    respondToTask
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<DepegServiceManagerCalls>
                    {
                        ...
                        .map(DepegServiceManagerCalls::setRewardsInitiator)
                    }
                    setRewardsInitiator
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<DepegServiceManagerCalls>
                    {
                        ...
                        .map(DepegServiceManagerCalls::stakeRegistry)
                    }
                    stakeRegistry
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<DepegServiceManagerCalls>
                    {
                        ...
                        .map(DepegServiceManagerCalls::avsDirectory)
                    }
                    avsDirectory
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<DepegServiceManagerCalls>
                    {
                        ...
                        .map(DepegServiceManagerCalls::renounceOwnership)
                    }
                    renounceOwnership
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<DepegServiceManagerCalls>
                    {
                        ...
                        .map(DepegServiceManagerCalls::createNewTask)
                    }
                    createNewTask
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<DepegServiceManagerCalls>
                    {
                        ...
                        .map(DepegServiceManagerCalls::latestTaskNum)
                    }
                    latestTaskNum
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<DepegServiceManagerCalls>
                    {
                        <ownerCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(DepegServiceManagerCalls::owner)
                    }
                    owner
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<DepegServiceManagerCalls>
                    {
                        ...
                        .map(DepegServiceManagerCalls::registerOperatorToAVS)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<DepegServiceManagerCalls>
                    {
                        ...
                        .map(DepegServiceManagerCalls::deregisterOperatorFromAVS)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<DepegServiceManagerCalls>
                    {
                        ...
                        .map(DepegServiceManagerCalls::updateAVSMetadataURI)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<DepegServiceManagerCalls>
                    {
                        ...
                        .map(DepegServiceManagerCalls::allTaskResponses)
                    }
                    allTaskResponses
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<DepegServiceManagerCalls>
                    {
                        ...
                        .map(DepegServiceManagerCalls::getRestakeableStrategies)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<DepegServiceManagerCalls>
                    {
                        ...
                        .map(DepegServiceManagerCalls::transferOwnership)
                    }
                    transferOwnership
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<DepegServiceManagerCalls>
                    {
                        ...
                        .map(DepegServiceManagerCalls::rewardsInitiator)
                    }
                    rewardsInitiator
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<DepegServiceManagerCalls>
                    {
                        <createAVSRewardsSubmissionCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                DepegServiceManagerCalls::createAVSRewardsSubmission,
                            )
                    }
    ...
    ///Container for all the [`DepegServiceManager`](self) events.
    pub enum DepegServiceManagerEvents {
    ...
    #[automatically_derived]
    impl DepegServiceManagerEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for DepegServiceManagerEvents {
        const NAME: &'static str = "DepegServiceManagerEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for DepegServiceManagerEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`DepegServiceManager`](self) contract instance.

    See the [wrapper's documentation](`DepegServiceManagerInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> DepegServiceManagerInstance<T, P, N> {
        DepegServiceManagerInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        ...
        Output = alloy_contract::Result<DepegServiceManagerInstance<T, P, N>>,
    > {
        DepegServiceManagerInstance::<T, P, N>::deploy(
            provider,
            _avsDirectory,
            _stakeRegistry,
            _delegationManager,
    ...
    >(
        ...
        DepegServiceManagerInstance::<T, P, N>::deploy_builder(
            provider,
            _avsDirectory,
            _stakeRegistry,
            _delegationManager,
    ...
    /**A [`DepegServiceManager`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`DepegServiceManager`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct DepegServiceManagerInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for DepegServiceManagerInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("DepegServiceManagerInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        > DepegServiceManagerInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            ...
            _stakeRegistry: alloy::sol_types::private::Address,
            _delegationManager: alloy::sol_types::private::Address,
        ) -> alloy_contract::Result<DepegServiceManagerInstance<T, P, N>> {
            let call_builder =
    ...
    impl<T, P: ::core::clone::Clone, N> DepegServiceManagerInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> DepegServiceManagerInstance<T, P, N> {
            DepegServiceManagerInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
        ...
        > DepegServiceManagerInstance<T, P, N>
    {
        ...
        pub fn respondToTask(
            &self,
            task: <IDepegServiceManager::Task as alloy::sol_types::SolType>::RustType,
